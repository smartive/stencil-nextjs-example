...
export const Accordion: FC = () => {
  ...
  useEffect(() => {
    const { current } = ref;
    const onAccordionChange = (event: Event) =>
      console.info((event as CustomEvent<string>)["detail"]);
    current?.addEventListener("accordionChange", onAccordionChange);

    return () =>
      current?.removeEventListener("accordionChange", onAccordionChange);
  }, [ref]);
    ...
    <AbcAccordionGroup ref={ref}>
      ...
      >
        <span slot="details">
          ...
          risus sem sollicitudin lacusNorem ipsum dolor sit amet, consectetur
